...
public class ChallengeController {
    ...
    //this method tells spring that any request come with this(/challenges) endpoint execute this method
    @GetMapping
    ...
    //This method get this parameter from request body. This post request has some additional info with it i.e, request body
    @PostMapping
